...
- Extraer como minimo: cliente, canal, fecha real, facturado y Ganancia Octopus.
- Rentabilidad = `Ganancia Octopus / Facturado * 100`.
- Si el cliente/canal tiene varias operaciones, acumular facturado y ganancia; nunca promediar porcentajes individuales.
- Nunca convertir un dato faltante en cero.
- Render debe mostrar solo clientes con al menos una operacion valida con cliente, facturado, ganancia y rentabilidad calculable.
...
- `OK_FC_NETA` / `OK_FC_HISTORICA` u operaciones con FC neta: usar solo cuando el cuadro, Facturacion Historica o una validacion previa habilita tomar ese importe como facturado.
- Si falta facturado visible, intentar cruce inequivoco contra Facturacion Historica antes de pedir revision.
...
- Fecha utilizada.
- Facturado y Ganancia Octopus utilizados.
